...
<div class = "tablebox">
    <div class = "tablebox">
		...
		<form action = "imushestvoupdatescript.php" method = "post">
		...
		<input type = "text" name = "Ploshad_GodPostr" class = "input" value = "<?= $client['Ploshad_GodPostr']?>">
		...
		<input type = "text" name = "Kreditor_Kredit" class = "input" value = "<?= $client['Kreditor_Kredit']?>">
