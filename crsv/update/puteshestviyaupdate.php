...
<div class = "tablebox">
    <div class = "tablebox">
		...
		<form action = "puteshestviyaupdatescript.php" method = "post">
		...
		<input type = "text" name = "Strahovan_Dop" class = "input" value = "<?= $client['Strahovan_Dop']?>">
		<p class = "formtext">Даты путешествия</p>
		<input type = "text" name = "Daty_Puteshestvii" class = "input" value = "<?= $client['Daty_Puteshestvii']?>">
		<p class = "formtext">Страна</p>
		<input type = "text" name = "Strana_Putesh" class = "input" value = "<?= $client['Strana_Putesh']?>">
