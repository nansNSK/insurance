...
mysqli_query($mysql, "INSERT INTO `clients` (`ID_clients`, `FIO`, `dataR`, `MestoProjiv`, `Passport`, `Num`, `ID_strahovanie`, `ID_podrazdel`, `stoimost`, `Data_strahovan`, `Sroc_strahovan`, `Strahovan_Dop`, `Viplaty`, `Auto_M_M_Y`, `GosNomerAvto`, `Voditel_Udostv`, `Ploshad_GodPostr`, `Kreditor_Kredit`, `Daty_Puteshestvii`, `Strana_Putesh`) VALUES (NULL, '$FIO', '$dataR', '$MestoProjiv', '$Passport', '$Num', '$ID_strahovanie', '$ID_podrazdel', '$stoimost', '$Data_strahovan', '$Sroc_strahovan', '$Strahovan_Dop', '$Viplaty', '', '', '', '', '', '', '')");
header('location: ../zdorovie.php');
?>